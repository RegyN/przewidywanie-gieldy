# Skopiowany z internetu przykład na sieć Elmana. Zapisałem, żeby mi nie umknął, ale przyznaję bez bicia, że
# na razie zbytnio mu się nie przyglądałem, poza takim powierzchownym sprawdzeniem, że to chyba rzeczywiście
# sieć Elmana.
# TODO: Sprawdzić czy to w ogóle działa
# TODO: Zmienić, żeby działało z naszymi danymi
# TODO: Przepisać na keras
# TODO: Zintegrować z resztą programu
